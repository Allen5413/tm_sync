...
public class Student extends AbstractEntity {
    ...
    private Integer idcardType;         //证件类型[0--其他  1--身份证 2--军官证 3--护照 4--港、澳、台居民证件]
    ...
    private Integer type;               //学生类型[0--普通学生 1--免试生 2--程学习生 3--函授 4--业余]
    private Integer state;              //学生状态[网院：53--停生 77--休学 78--退学 54--在籍学生  55--已毕业学.  教材：0--在籍学生 1--停生 2--休学 3--退学 4--已毕业学.]
