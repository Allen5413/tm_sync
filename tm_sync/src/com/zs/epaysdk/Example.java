...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        Configure.setAppid("Q0000468");                                //商户ID，appid
        Configure.setCommKey("DFFEC89329B74AC88E2A2F24516DA88D");      //商户秘钥
        Configure.setSub_mrch("重庆西网文化传播有限公司");                          //二级商户名称
    ...
    public void gatePayExample() {
        ...
        String ex2_1html = EPay.gpPay(order_no, order_amount, order_title, order_desc);
