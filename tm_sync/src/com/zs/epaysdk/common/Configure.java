...
public class Configure {
    ...
    // 二级商户名称，可为空
    private static String sub_mrch = "重庆西网文化传播有限公司";
    ...
    public static String httpsRequestClassName = "com.zs.epaysdk.comm.HttpsPostRequest";
