...
//            }
    ...
    private Map<String, Map<String, Map<Float, Map<Integer, String>>>> map = new HashMap<String, Map<String, Map<Float, Map<Integer, String>>>>();
        ...
        try{
            ...
            if(null != studentOrderList && 0 < studentOrderList.size()){
                ...
                for(Object[] objs : studentOrderList){
                    ...
                    String courseCode = bb(name, author, price);
    ...
    public String bb(String name, String author, float price){
        String courseCode = "";
        Map<String, Map<Float, Map<Integer, String>>> authorMap = map.get(name);
        if(null != authorMap){
            Map<Float, Map<Integer, String>> priceMap = authorMap.get(author);
