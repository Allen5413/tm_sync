...
import com.zs.weixin.common.bean.WxJsapiSignature;
...
public interface WxMpService {
   ...
   * @return
   * @throws com.zs.weixin.common.exception.WxErrorException
   */
   ...
   * </pre>
   * @param mediaType         媒体类型, 请看{@link com.zs.weixin.common.api.WxConsts}
   * @param fileType          文件类型，请看{@link com.zs.weixin.common.api.WxConsts}
   ...
   * </pre>
   * @param mediaType         媒体类型, 请看{@link com.zs.weixin.common.api.WxConsts}
   * @param material          上传的素材, 请看{@link com.zs.weixin.mp.bean.WxMpMaterial}
   * @return
   * @throws com.zs.weixin.common.exception.WxErrorException
   */
   ...
   * 详情请见: http://mp.weixin.qq.com/wiki/14/7e6c03263063f4813141c3e17dd4350a.html
   * </pre>
   * @param news              上传的图文消息, 请看{@link com.zs.weixin.mp.bean.WxMpMaterialNews}
   * @return
   * @throws com.zs.weixin.common.exception.WxErrorException
   */
   ...
   * </pre>
   * @param wxMpMaterialArticleUpdate     用来更新图文素材的bean, 请看{@link com.zs.weixin.mp.bean.WxMpMaterialArticleUpdate}
   * @return
   * @throws com.zs.weixin.common.exception.WxErrorException
   */
   ...
   * 详情请见: http://mp.weixin.qq.com/wiki/12/2108cd7aafff7f388f41f37efa710204.html
   * </pre>
   * @param type        媒体类型, 请看{@link com.zs.weixin.common.api.WxConsts}
   * @param offset      从全部素材的该偏移位置开始返回，0表示从第一个素材 返回
   * @param count       返回素材的数量，取值在1到20之间
   * @return
   * @throws com.zs.weixin.common.exception.WxErrorException
   ...
   * @param news
   * @throws com.zs.weixin.common.exception.WxErrorException
   * @see #massGroupMessageSend(com.zs.weixin.mp.bean.WxMpMassGroupMessage)
   * @see #massOpenIdsMessageSend(com.zs.weixin.mp.bean.WxMpMassOpenIdsMessage)
   */
   ...
   * <pre>
   * 分组群发消息
   * 如果发送图文消息，必须先使用 {@link #massNewsUpload(com.zs.weixin.mp.bean.WxMpMassNews)} 获得media_id，然后再发送
   * 如果发送视频消息，必须先使用 {@link #massVideoUpload(com.zs.weixin.mp.bean.WxMpMassVideo)} 获得media_id，然后再发送
   * 详情请见: http://mp.weixin.qq.com/wiki/index.php?title=高级群发接口
   * </pre>
   * @param message
   * @throws com.zs.weixin.common.exception.WxErrorException
   ...
   * 可以参考，{@link com.zs.weixin.common.util.http.MediaUploadRequestExecutor}的实现方法
   * </pre>
   * @param executor
   * @param uri
   * @param data
   ...
   * @return
   * @deprecated Use com.zs.weixin.mp.api.WxMpService.getPrepayId(Map<String, String>) instead
   */
  @Deprecated
  WxMpPrepayIdResult getPrepayId(String openId, String outTradeNo, double amt, String body, String tradeType, String ip, String notifyUrl)throws Exception;
   ...
   */
  WxMpPrepayIdResult getPrepayId(Map<String, String> parameters)throws Exception;
   ...
   * @return
   */
  Map<String, String> getJSSDKPayInfo(Map<String, String> parameters)throws Exception;
   ...
   * @param notifyUrl 通知地址
   * @return
   * @deprecated Use com.zs.weixin.mp.api.WxMpService.getJSSDKPayInfo(Map<String, String>) instead
   */
  @Deprecated
  Map<String, String> getJSSDKPayInfo(String openId, String outTradeNo, double amt, String body, String tradeType, String ip, String notifyUrl)throws Exception;
