...
import com.zs.weixin.common.session.StandardSessionManager;
import com.zs.weixin.common.session.WxSessionManager;
import com.zs.weixin.common.util.RandomUtils;
import com.zs.weixin.common.util.StringUtils;
import com.zs.weixin.common.util.crypto.SHA1;
import com.zs.weixin.common.util.crypto.WxCryptUtil;
import com.zs.weixin.common.util.fs.FileUtils;
import com.zs.weixin.common.util.http.*;
import com.zs.weixin.common.util.json.GsonHelper;
import com.zs.weixin.common.util.json.WxGsonBuilder;
import com.zs.weixin.common.util.xml.XStreamInitializer;
import com.zs.weixin.mp.bean.*;
import com.zs.weixin.mp.bean.result.*;
import com.zs.weixin.mp.util.http.*;
import com.zs.weixin.mp.util.json.WxMpGsonBuilder;
...
public class WxMpServiceImpl implements WxMpService {
  ...
  protected WxMpConfigStorage wxMpConfigStorage = new WxMpInMemoryConfigStorage();
  ...
  @Override
  public WxMpPrepayIdResult getPrepayId(String openId, String outTradeNo, double amt, String body, String tradeType, String ip, String callbackUrl)throws Exception {
  ...
  public WxMpPrepayIdResult getPrepayId(final Map<String, String> parameters)throws Exception{
  ...
  @Override
  public Map<String, String> getJSSDKPayInfo(String openId, String outTradeNo, double amt, String body, String tradeType, String ip, String callbackUrl)throws Exception {
    Map<String, String> packageParams = new HashMap<String, String>();
    packageParams.put("appid", wxMpConfigStorage.getAppId());
    packageParams.put("mch_id", wxMpConfigStorage.getPartnerId());
    packageParams.put("body", body);
  ...
  @Override
  public Map<String, String> getJSSDKPayInfo(Map<String, String> parameters)throws Exception {
