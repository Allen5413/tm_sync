...
//changelog: 增强tree功能，支持定义自定义的显示字段名称. by zhangpu/2013-7-5
var fieldText = item.text;
if(_ff.formatter){ fieldText = _ff.formatter(item);}
$.data(node[0],"tree-node",{id:item.id,text:fieldText,iconCls:item.iconCls,attributes:item.attributes});
$("<span class=\"tree-title\"></span>").html(fieldText).appendTo(node);
...
cc.push("\">");
if(col.checkbox){
// changelog 修改datagrid生成的checkbox的默认值为formatter返回的值（如果定义了formatter的情况） by zhangpu on 2013-07-06
var checkboxValue=col.formatter?col.formatter(_644,_641,_640):_644;
cc.push("<input type=\"checkbox\" name=\""+_643+"\" value=\""+checkboxValue+"\"/>");
//end changelog
